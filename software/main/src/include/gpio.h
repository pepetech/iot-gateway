...
#define FT6X36_IRQ()        PERI_REG_BIT(&(GPIO->P[0].DIN), 13)
#define TFT_RESET()         PERI_REG_BIT_CLEAR(&(GPIO->P[0].DOUT)) = BIT(12)
#define TFT_UNRESET()       PERI_REG_BIT_SET(&(GPIO->P[0].DOUT)) = BIT(12)
